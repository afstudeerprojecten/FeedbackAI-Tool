        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-8">
            ...
            <div className="card shadow-lg p-6">
                <div className="flex justify-center">
                    <img src="../img/openai.png" alt="Math" className="w-42 h-42" />
                </div>
            ...
            <div className="card shadow-lg p-6">
                <div className="flex justify-center">
                    <img src="../img/course.jpeg" alt="Science" className="w-42 h-42" />
                </div>
            ...
            <div className="card shadow-lg p-6">
                <div className="flex justify-center">
                    <img src="../img/openai.png" alt="History" className="w-42 h-42" />
                </div>
